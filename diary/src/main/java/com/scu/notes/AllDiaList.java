...
import com.scu.notes.adapter.MainAdapter;
import com.scu.notes.bean.SQLBean;
import com.scu.notes.data.CallAlarm;
import com.scu.notes.db.DatabaseOperation;
import com.scu.notes.doubledatepicker.DoubleDatePickerDialog;
import com.scu.notes.view.MyGridView;
...
public class AllDiaList extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			Intent intent = new Intent(AllDiaList.this, CallAlarm.class);
			PendingIntent sender = PendingIntent.getBroadcast(
					AllDiaList.this, 0, intent, 0);
						...
						switch (which) {
							...
							case 0:
								if ("0".equals(locktype)) {//判断是否添加了秘密锁0没有
									Intent intent = new Intent(AllDiaList.this,
	...
	class ItemClickEvent implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			if ("0".equals(locktype)) {
				Intent intent = new Intent(AllDiaList.this, AddActivity.class);
	...
	public void inputTitleDialog(final String lock, final int idtype,
		...
		builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if ("".equals(inputName)) {
					Toast.makeText(AllDiaList.this, "密码不能为空请重新输入！",
					...
					if (inputName.equals(lock)) {
						...
						Toast.makeText(AllDiaList.this, "密码不正确！",
								Toast.LENGTH_LONG).show();
					}
				}
			}
	...
	public void onSearch(View v) {
		...
		if ("".equals(ek)) {//判断搜索关键词是否为空
			Toast.makeText(AllDiaList.this, "请输入关键词！", Toast.LENGTH_LONG)
					.show();
		} else {//搜索不为空
			//进入搜索结果页
			Intent intent = new Intent(AllDiaList.this, SearchActivity.class);
	...
	public void onData(View v) {
		...
		new DoubleDatePickerDialog(AllDiaList.this, 0,
				new DoubleDatePickerDialog.OnDateSetListener() {
					...
					public void onDateSet(DatePicker startDatePicker,
						...
						if (startYear < endYear || startYear == endYear
							...
							Toast.makeText(AllDiaList.this, "日期选择错误请重新选择！",
									Toast.LENGTH_LONG).show();
						}
					}
	...
	public void onAbout(View v) {
		Intent intent = new Intent(AllDiaList.this, About.class);
		startActivity(intent);
	}
}
