...
public class CountDownProgress extends View {
    ...
    private static final int DEFAULT_CIRCLE_STROKE_COLOR = Color.parseColor("#F2F2F2");
    private static final int DEFAULT_CIRCLE_STROKE_WIDTH = 2;//外圈
    private static final int DEFAULT_CIRCLE_RADIUS =100;

    private static final int PROGRESS_COLOR = Color.parseColor("#87CEEB");//进度条颜色
    private static final int PROGRESS_WIDTH = 2;//内

    private static final int SMALL_CIRCLE_SOLIDE_COLOR = Color.parseColor("#FFFFFF");
    private static final int SMALL_CIRCLE_STROKE_COLOR = Color.parseColor("#87CEEB");
    private static final int SMALL_CIRCLE_STROKE_WIDTH = 2;
    private static final int SMALL_CIRCLE_RADIUS = 6;

    private static final int TEXT_COLOR = Color.parseColor("#D1EEEE");
    ...
    public void countDownStop(){
        progressPaint.setColor(getResources().getColor(android.R.color.transparent));
        animator.cancel();
        smallCirclePaint.setColor(getResources().getColor(android.R.color.transparent));
        smallCircleSolidePaint.setColor(getResources().getColor(android.R.color.transparent));
        if(timer != null){
